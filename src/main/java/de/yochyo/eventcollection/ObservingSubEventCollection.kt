 ...
 */
open class ObservingSubEventCollection<T : IObservableObject<T, A>, A>(c: MutableCollection<T>, parentCollection: EventCollection<T>, filter: (e: T) -> Boolean) : SubEventCollection<T>(c, parentCollection, filter) {
